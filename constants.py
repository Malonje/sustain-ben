...
MEANS = {'l8': {'cauvery': np.array([12217.32277969, 12511.15536019, 13493.15976489, 13366.33617632,
                                     19127.91350998, 14104.20895414, 11855.66455860, 30041.45716741])},
         's1': {'cauvery': np.array([5.51955486e+04, 5.54828155e+04, 3.52737633e+01]),
                'ghana': np.array([-10.50, -17.24, 1.17]),
                'southsudan': np.array([-9.02, -15.26, 1.15]),
                'tanzania': np.array([-9.80, -17.05, 1.30])},
         's2': {'cauvery': np.array([2591.10033617, 2642.04728972, 2523.2409565, 2908.85152681, 3584.01759874,
                                     3893.86560266, 3819.97965536, 4029.6810336, 2349.47416858, 1710.13549953]),
                'ghana': np.array(
...
STDS = {'l8': {'cauvery': np.array([9839.83943076, 9719.79741972, 9072.13215297, 9084.40693755,
                                    8997.40633037, 6620.70860346, 5548.67975164, 19659.93478777])},
        's1': {'cauvery': np.array([2.38810734e+04, 2.35996859e+04, 7.44437723e+00]),
               'ghana': np.array([3.57, 4.86, 5.60]),
               'southsudan': np.array([4.49, 6.68, 21.75]),
               'tanzania': np.array([3.53, 4.78, 16.61])},
        's2': {'cauvery': np.array([3158.76291025, 2712.25436227, 2634.68109187, 2648.49819773, 2295.40207077,
                                    2190.95583057, 2214.88060290, 2125.53174617, 1444.80166392, 1284.23252724]),
                'ghana': np.array(
