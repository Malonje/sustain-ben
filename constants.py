...
MEANS = {'regionwise': {'l8': {'cauvery': np.array([12207.0043467,  12510.42688324, 13501.40754119, 13390.49839667,
                                    19194.81071226, 14243.6708041,  11956.99396042, 29937.07524899])},
         's1': {'cauvery': np.array([5.44914901e+04, 5.48048451e+04, 3.55861682e+01]),
                'ghana': np.array([-10.50, -17.24, 1.17]),
                'southsudan': np.array([-9.02, -15.26, 1.15]),
                'tanzania': np.array([-9.80, -17.05, 1.30])},
         's2': {'cauvery': np.array([2455.62673204, 2517.5498179,  2406.31126029, 2782.24757522, 3485.50771008,
                                3805.42394561, 3721.18962503, 3954.23668642, 2339.44288454, 1704.26071802]),
                'ghana': np.array(
         ...
         's2_cldfltr': {'ghana': np.array(
           ...
           'plotwise': {'l8': {'cauvery': np.array([12310.1415527,  12601.49720635, 13580.75772858, 13455.17799956,
                                     19195.26295846, 14128.38105087, 11895.46754548, 30260.06255793])},
         's1': {'cauvery': np.array([5.62667817e+04, 5.65732920e+04, 3.54810658e+01]),
                'ghana': np.array([-10.50, -17.24, 1.17]),
                'southsudan': np.array([-9.02, -15.26, 1.15]),
                'tanzania': np.array([-9.80, -17.05, 1.30])},
         's2': {'cauvery': np.array([2538.80096518, 2588.5243769,  2470.13986612, 2850.10563068, 3527.81349835,
                            3839.18266098, 3760.42818503, 3978.41254634, 2318.97261701, 1691.32361157]),
                'ghana': np.array(
             [2620.00, 2519.89, 2630.31, 2739.81, 3225.22, 3562.64, 3356.57, 3788.05, 2915.40, 2102.65]),
                'southsudan': np.array(
                    [2119.15, 2061.95, 2127.71, 2277.60, 2784.21, 3088.40, 2939.33, 3308.03, 2597.14, 1834.81]),
...
STDS = {'regionwise':{'l8': {'cauvery': np.array([ 9724.02795536,  9605.98026371,  8959.59874564,  8974.05954351,
                                    8858.85739552,  6565.49693668,  5496.64512366, 19775.61872232])},
        's1': {'cauvery': np.array([2.45234689e+04, 2.42342478e+04, 7.36162415e+00]),
               'ghana': np.array([3.57, 4.86, 5.60]),
               'southsudan': np.array([4.49, 6.68, 21.75]),
               'tanzania': np.array([3.53, 4.78, 16.61])},
        's2': {'cauvery': np.array([3105.48493131, 2607.63151732, 2537.38636615, 2543.98717941, 2210.28653354,
                                2119.8676155,  2145.34771929, 2065.70935136, 1414.10632408, 1260.02304527]),
                'ghana': np.array(
        ...
        's2_cldfltr': {
          ...
          'plotwise':{'l8': {'cauvery': np.array([ 9856.19668872,  9727.96101055,  9066.51519721,  9077.46765674,
                             8923.4360929,   6522.83671718,  5466.46433036, 19528.16351531])},
        's1': {'cauvery': np.array([2.28274487e+04, 2.24987215e+04, 7.49399872e+00]),
               'ghana': np.array([3.57, 4.86, 5.60]),
               'southsudan': np.array([4.49, 6.68, 21.75]),
               'tanzania': np.array([3.53, 4.78, 16.61])},
        's2': {'cauvery': np.array([3181.51175997, 2681.41025809, 2604.82289565, 2618.31887883, 2268.52076387,
                            2166.96910003, 2195.06140709, 2106.19058119, 1422.63302124, 1266.65741087]),
                'ghana': np.array(
            [2171.62, 2085.69, 2174.37, 2084.56, 2058.97, 2117.31, 1988.70, 2099.78, 1209.48, 918.19]),
               'southsudan': np.array(
                   [2113.41, 2026.64, 2126.10, 2093.35, 2066.81, 2114.85, 2049.70, 2111.51, 1320.97, 1029.58]),
